    ...
    <div class="not-found__wrap">
        <div class="not-found__pic">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <polygon style="fill:#FB0023;" points="345.043,311.652 311.652,311.652 311.652,278.261 200.348,278.261 200.348,311.652
                    166.957,311.652 166.957,411.826 200.348,411.826 200.348,445.217 311.652,445.217 311.652,411.826 345.043,411.826 "/>
                <polygon points="155.826,144.696 122.435,144.696 122.435,189.217 77.913,189.217 77.913,222.609 122.435,222.609 122.435,267.13
                    155.826,267.13 155.826,222.609 200.348,222.609 200.348,189.217 155.826,189.217 "/>
                <polygon points="434.087,189.217 389.565,189.217 389.565,144.696 356.174,144.696 356.174,189.217 311.652,189.217
                    311.652,222.609 356.174,222.609 356.174,267.13 389.565,267.13 389.565,222.609 434.087,222.609 "/>
        ...
        <div class="not-found__text">
            Страница не найдена, либо устарела
        </div>
    </div>
</template>

<script src="./raw/Error.js"></script>